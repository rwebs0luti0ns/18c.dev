...
<form class="box box-solid" id="form-category" method="post" action="{{ url('admin/categories/'.$category->id) }}">@csrf @method('put')
    <div class="box-body row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
            <label>Category Name: <font color="red">*</font></label>
            <input type="text" class="form-control" value="{{ $category->name }}" name="name" required="" placeholder="Enter Category Name">
        </div>
    </div>
