...
@stop
@section('content')
   <form class="box box-solid" method="post" action="{{ url('franchisee/customers') }}" id="customer-form">@csrf
       <div class="box-body row">
             ...
             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
                ...
                <input type="text" class="form-control" value="{{ old('contact_no') }}" name="contact_no" required="" placeholder="Enter Name">
            </div>
             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
                <label>Email: <font color="red">*</font></label>
                <input type="email" class="form-control" value="{{ old('email') }}" name="email" required="" placeholder="Enter Name">
            </div>
